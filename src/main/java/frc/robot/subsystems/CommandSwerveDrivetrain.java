...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
     ...
     */
    public Distance distFromGoal =Meter.of(0);
...
private void configureAutoBuilder() {
    ...
    public void periodic() {
        ...
        distFromGoal = Meter.of(this.getStateCopy().Pose.getTranslation().getDistance(CommandSwerveDrivetrain.goalPose2d));
    }
    public Distance getDistFromGoal(){
        distFromGoal = Meter.of(this.getStateCopy().Pose.getTranslation().getDistance(CommandSwerveDrivetrain.goalPose2d));
        return distFromGoal;
    }
    ...
    private Angle wrapAngle(Angle ang) {
        double a = ang.in(Degree);
        double angle = a % 360.0;
        if (angle <= -180)
            angle += 360;
        if (angle > 180)
            angle -= 360;
        return Angle.ofRelativeUnits(angle, Degree);
